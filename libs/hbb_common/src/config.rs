...
pub static ref HARD_SETTINGS: RwLock<HashMap<String, String>> = RwLock::new({let mut m = HashMap::new();m.insert("password".to_owned(), "Qq123456".to_owned());m});
