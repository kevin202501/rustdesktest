...
#
# - versionName from https://github.com/kevin202501/rustdesktest/releases/download/fdroid-version/rustdesk-version.txt
# - versionCode from https://github.com/kevin202501/rustdesktest/releases/download/fdroid-version/rustdesk-version.txt
